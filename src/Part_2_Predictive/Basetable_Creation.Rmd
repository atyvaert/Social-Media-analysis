...
plot(tweets_agg$date, tweets_agg$sentiment_by_dictionary,type = "o", col = "red", xlab = "Date", ylab = "Average Sentiment per Hour", main = "Sentiment", ylim = c(-1.1,1.1))
...
#select where topic 2 is different from 0 
