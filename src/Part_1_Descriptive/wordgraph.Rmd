...
tweets$is_no_bot <- !grepl("Poshmark",tweets$text)

tweets <- tweets[tweets$is_no_bot == TRUE,]

tweets <- subset(tweets, select = -tweets$is_no_bot)
...
tweets$text[grep("Poshmark",tweets$text)]
```
