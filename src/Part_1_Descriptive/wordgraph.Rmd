...
load("/Users/wouterdewitte/Documents/GitHub/SMWA_Performance/data/all_tweets.Rdata")
...
set.seed(123)
all_tweets <- all_tweets[sample(nrow(all_tweets), size = 500, replace = FALSE),]  
# change to text
...
#adj_mat <- mclapply(doc_term_mat, create_adjacency_matrix, numCores)
